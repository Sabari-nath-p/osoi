...
import '../Converter/refundOrder.dart';
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                width: 30,
                                decoration: BoxDecoration(
                                    color: (val > 0) ? appprimarycolor : null,
                          ...
                          Container(
                            width: 2,
                            color: (val > 1) ? appprimarycolor : null,
                            height: 30,
                          ...
                          Container(
                            width: 2,
                            color: (val > 2) ? appprimarycolor : null,
                            height: 30,
                            margin: EdgeInsets.only(left: 14),
                            child: (val <= 2)
                                ? DashedRect(
                          ...
                          Container(
                            width: 2,
                            color: (val > 3) ? appprimarycolor : null,
                            height: 30,
                            margin: EdgeInsets.only(left: 14),
                            child: (val <= 3)
                                ? DashedRect(
                          ...
                          Container(
                            width: 2,
                            color: (val > 4) ? appprimarycolor : null,
                            height: 30,
                            margin: EdgeInsets.only(left: 14),
                            child: (val <= 4)
                                ? DashedRect(
                          ...
                          Container(
                            width: 2,
                            color: (val > 5) ? appprimarycolor : null,
                            height: 30,
                            margin: EdgeInsets.only(left: 14),
                            child: (val <= 5)
                                ? DashedRect(
                    ...
                    height(11),
                    if (data["pre_order_date"] != null)
                      Text(
                        "     Pickup Date - ${data["pre_order_date"]}",
                        style: TextStyle(
                            fontSize: 14,
                            fontFamily: "Montserrat",
                            fontWeight: FontWeight.w600),
